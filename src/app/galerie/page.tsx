...
const allImages = [
  ...
  {
    id: 7,
    src: "https://images.unsplash.com/photo-1501854140801-50d01698950b?q=80&w=1024",
    alt: "Paysages ruraux",
    category: "Nature",
  },
  {
    id: 8,
    src: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?q=80&w=1024",
    alt: "Travail aux champs",
    category: "Agriculture",
  },
  {
    id: 9,
    src: "https://images.unsplash.com/photo-1592911255523-d343f8a4860b?q=80&w=1024",
    alt: "Récolte de maïs",
    category: "Agriculture",
  },
  {
    id: 10,
    src: "https://images.unsplash.com/photo-1584362923647-784750ad247a?q=80&w=1024",
    alt: "Clinique mobile",
    category: "Santé",
  },
  {
    ...
    alt: "Soutien aux orphelins",
    category: "Protection",
  },
  {
    id: 12,
    src: "https://images.unsplash.com/photo-1541252260737-0402bb74b99d?q=80&w=1024",
    alt: "Accès à l'eau",
    category: "Eau",
  },
];
      ...
      <main className="flex-1 pt-32 pb-24">
        ...
        <div className="bg-primary-dark py-20 mb-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-12 lg:px-24 relative z-10 text-center">
            ...
            >
              Notre Galerie{" "}
              <span className="text-secondary-blue-vlight underline decoration-accent-gold underline-offset-8">
                Photos
              </span>
            </motion.h1>
            <motion.p
            ...
            >
              Plongez dans l&apos;univers de nos projets à travers le regard de
              nos équipes et des communautés que nous servons en RDC.
            </motion.p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-12 lg:px-24">
          <div className="flex justify-between items-center mb-12">
            <Link
              href="/"
              className="flex items-center gap-2 text-primary-dark hover:text-primary-medium transition-colors font-bold group"
            >
              <svg
            ...
            {allImages.map((img) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-linear-to-t from-primary-dark/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                  ...
                  <h4 className="text-white text-lg font-bold">{img.alt}</h4>
                </div>
              </motion.div>
            ))}
          </motion.div>
