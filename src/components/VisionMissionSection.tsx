    ...
    <section className="relative w-full py-24 md:py-40 bg-secondary-dark-teal overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 xl:px-32 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24">
        ...
        <motion.div 
            ...
            whileHover={{ y: -10 }}
            className="group bg-primary-medium rounded-[48px] overflow-hidden flex flex-col shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] transition-all duration-500"
        >
          ...
          <div className="p-10 md:p-14 flex flex-col flex-1">
            ...
            <p className="text-white text-lg leading-relaxed font-light opacity-95">
        ...
        <motion.div 
            ...
            transition={{ duration: 0.8 }}
            whileHover={{ y: -10 }}
            className="group bg-[#062c1f] rounded-[48px] overflow-hidden flex flex-col shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] transition-all duration-500"
        >
          <div className="h-72 sm:h-80 md:h-96 relative overflow-hidden">
            <Image 
          ...
          <div className="p-10 md:p-14 flex flex-col flex-1">
            ...
            <p className="text-white text-lg leading-relaxed font-light mb-8 opacity-95">
            ...
            <ul className="space-y-6">
              {[
                ...
                >
                  ...
                  <span className="text-white text-lg font-light opacity-90">{item}</span>
                </motion.li>
              ))}
            </ul>
          </div>
