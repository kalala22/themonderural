  ...
  const interventionAxes: Axe[] = [
    {
      ...
      detailImage:
        "https://images.unsplash.com/photo-1592911255523-d343f8a4860b?q=80&w=1200",
      icon: (
        <svg
      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M2.25 18L9 11.25l4.5 4.5L21.75 7.5M21.75 7.5V12.75M21.75 7.5H16.5"
          />
        </svg>
      ),
    },
    ...
    },
    {
      ...
      detailImage:
        "https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?q=80&w=1200",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      detailImage:
        "https://images.unsplash.com/photo-1584362923647-784750ad247a?q=80&w=1200",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      detailImage:
        "https://images.unsplash.com/photo-1541252260737-0402bb74b99d?q=80&w=1200",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      detailImage:
        "https://images.unsplash.com/photo-1529391409740-59f2dee08361?q=80&w=1200",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1"
          />
        </svg>
      ),
    },
    {
      ...
      detailImage:
        "https://images.unsplash.com/photo-1517457373958-b7bdd058a548?q=80&w=1200",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M9.53 16.122a3 3 0 00-3.012 3.536L6.5 21h11l-.018-1.342a3 3 0 00-3.012-3.536l-4.94 0zM12 3c1.38 0 2.5 1.12 2.5 2.5S13.38 8 12 8 9.5 6.88 9.5 5.5 10.62 3 12 3zM15.5 11l-7 0 0 4 7 0 0-4z"
          />
        </svg>
      ),
    },
        ...
        {selectedAxe && (
          ...
          >
            ...
            >
              {/* Left Content Column */}
              <div
                className={`w-full md:w-1/2 p-8 md:p-16 flex flex-col ${selectedAxe.color.split(" ")[0]} relative`}
              >
                {/* Close Button Mobile */}
                <button
                  onClick={() => setSelectedAxe(null)}
                ...
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  >
                    <div
                      className={
                        selectedAxe.color.includes("vlight")
                          ? "text-primary-dark"
                          : "text-primary-medium"
                      }
                    >
